    ...
    <div class="w-full mx-auto">
      ...
      <div class="mt-10">
        <div class="flex flex-col sm:flex-row justify-between space-y-2">
          ...
          <RouterLink to="/user/announcements" class="flex items-center gap-2 underline text-sm">
            View All <MoveRight class="size-4" />
          </RouterLink>
        </div>
      ...
      <div class="mt-10">
        <div class="flex flex-col sm:flex-row justify-between space-y-2">
          ...
          <RouterLink to="/user/events" class="flex items-center gap-2 underline text-sm">
            View All <MoveRight class="size-4" />
          </RouterLink>
        </div>
