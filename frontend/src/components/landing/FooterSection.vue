...
<footer class="bg-gradient-to-b from-secondary via-secondary to-green-100/90 py-16">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <a href="https://flowbite.com/" class="flex items-center">
                  <!-- <img src="https://flowbite.com/docs/images/logo.svg" class="h-7 me-3" alt="FlowBite Logo" /> -->
                  <span class="text-heading self-center text-2xl font-semibold ">Get in Touch with the City Government</span>
              </a>

              <div class="mt-4">
                    <ul class="space-y-4 text-green-900">
                        <li class=""><i class="pi pi-map-marker pr-1 text-primary"></i> Tacloban City Hall, Kanhuraw Hill, Tacloban City, Leyte</li>
                        <li> <i class="pi pi-phone pr-1 text-primary"></i> (053) 832-5432</li>
                        <li><i class="pi pi-envelope pr-1 text-primary"></i>  info@mytacloban.gov.ph</li>
                    </ul>
              </div>
          </div>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-body sm:text-center">© 2023 <a href="https://flowbite.com/" class="hover:underline">MyTacloban</a>. All Rights Reserved.
          </span>
