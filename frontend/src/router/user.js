...
export default[
    {
        ...
        meta: {requiresAuth: true, role: ['CITIZEN'], layout: 'sidebar'}
    },
    {
        path: '/user/announcements',
        name: 'user.announcements',
        component: AnnoucementView,
        meta: {requiresAuth: true, role: ['CITIZEN'], layout: 'sidebar', title: 'Announcements'}
    },
    {
        path: '/user/submit-report',
        name: 'user.submit-report',
        component: SubmitReportView,
        meta: {requiresAuth: true, role: ['CITIZEN'], layout: 'sidebar', title: 'Submit Report'}
    },
    {
        path: '/user/reports-tracking',
        name: 'user.reports-tracking',
        component: ReportsTrackingView,
        meta: {requiresAuth: true, role: ['CITIZEN'], layout: 'sidebar', title: 'Reports Tracking' }
    },
    {
        path: '/user/barangay-informations',
        name: 'user.barangay-informations',
        component: BarangayInformationsView,
        meta: {requiresAuth: true, role: ['CITIZEN'], layout: 'sidebar', title: 'Barangay Information'}
    },
    {
        path: '/user/events',
        name: 'user.events',
        component: EventsView,
        meta: {requiresAuth: true, role: ['CITIZEN'], layout: 'sidebar', title: 'Events'}
    },
    {
        path: '/user/profile',
        name: 'user.profile',
        component: ProfileView,
        meta: {requiresAuth: true, role: ['CITIZEN'], layout: 'sidebar', title: 'Profile Settings'}
    },
